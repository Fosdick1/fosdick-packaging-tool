    ...
    <div style={{ maxWidth: 600, margin: 'auto', padding: 20 }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 15 }}>
        <div style={{ display: 'flex', gap: 10 }}>
          <input name="length" type="number" placeholder="Avg Item Length" value={form.length} onChange={handleChange} style={{ flex: 1, padding: 8 }} required />
          <input name="width" type="number" placeholder="Avg Item Width" value={form.width} onChange={handleChange} style={{ flex: 1, padding: 8 }} required />
        ...
        <div style={{ display: 'grid', gap: 4 }}>
          ...
          <div>
            <label style={{ marginRight: 10 }}>
              <input type="radio" name="hazmat" value="yes" checked={form.hazmat==='yes'} onChange={handleChange} /> Yes
            </label>
            <label>
              <input type="radio" name="hazmat" value="no" checked={form.hazmat==='no'} onChange={handleChange} /> No
            </label>
          </div>
          {form.hazmat==='yes' && (
            <select name="hazmatClass" value={form.hazmatClass} onChange={handleChange} style={{ padding: 8 }} required>
              ...
              <optgroup label="Classes">
                ...
                <option value="Class_9">Misc Misc. (Class 9)</option>
              </optgroup>
            </select>
          )}
        </div>
        <button type="submit" style={{ padding: 12, background: '#000', color: '#fff' }}>Get Recommendation</button>
      </form>
